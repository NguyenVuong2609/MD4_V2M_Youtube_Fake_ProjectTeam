...
<nav class="container-fluid fixed-top bg-white pt-2" id="top_nav">
    <div class="row">
        <div class="col-4 pl-4">
            <a class="navbar-brand" href=""><img src="https://firebasestorage.googleapis.com/v0/b/giangvan-248ea.appspot.com/o/logo.png?alt=media&token=ea07d5cc-ec42-4e5e-839c-22b6558e49ae" width="10%"></a>
        </div>
        <div class="col-4">
...
<nav class="container-fluid fixed-top bg-white pt-3" id="top_nav_mobile">
    <div class="row">
        <div class="col-3 pl-4">
            <a class="navbar-brand" href="index.html"><img src="https://firebasestorage.googleapis.com/v0/b/giangvan-248ea.appspot.com/o/logo.png?alt=media&token=ea07d5cc-ec42-4e5e-839c-22b6558e49ae" class="mb-2" width="10%"></a>
        </div>
        <div class="col-7">
            <form>
                <div class="input-group mb-3">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-3 col-sx-10 p-2">
                    <a href="">
                        <div class="card">
                            <img src="https://firebasestorage.googleapis.com/v0/b/giangvan-248ea.appspot.com/o/mancity.jpg?alt=media&token=04439fab-f8fc-40b9-a45c-d61e751baab6" height="174" />
                            <div class="row">
                                ...
                                <div class="col-10 mt-3">
                                    <p class="mb-2" title="Full Song: KHAIRIYAT (BONUS TRACK) | CHHICHHORE | Sushant, Shraddha | Pritam, Amitabh B|Arijit Singh">Full Song: KHAIRIYAT (BONUS TRACK) | CHHICHHORE | Sushant, Shraddha | Pritam, Amitabh B|Arijit Singh</p>
                ...
                <div class="col-md-3 p-2">
                    <a href="">
                        <div class="card">
                            <img src="https://firebasestorage.googleapis.com/v0/b/giangvan-248ea.appspot.com/o/mancity.jpg?alt=media&token=04439fab-f8fc-40b9-a45c-d61e751baab6" alt="image" height="174" />
                            <div class="row">
                                <div class="col-2 mt-3">
                                    <img id="img" width="48" src="https://yt3.ggpht.com/a-/AOh14GinKFFtcXMMwrPfhFbie8tgLV0vMzfvVFSMlw=s68-c-k-c0x00ffffff-no-rj-mo" class="rounded-circle">
                                </div>
